...
func create_deployment(config Config) int {
	...
	aws ec2 authorize-security-group-ingress --group-id $_AWS_sg --protocol tcp --port 9090 --cidr 0.0.0.0/0 &
	...
	case "gcp":
        ...
        gcloud compute firewall-rules create allow-external --allow=tcp:22,tcp:80,tcp:443,tcp:6443,tcp:30000-32768,tcp:5900,tcp:9090 --network px-net --project $_GCP_project &
